...
export const DashboardClient = ({ initialLayout, userId, activeAppCodes = [], isPro = false, credits = 0, tasks = [] }: DashboardClientProps) => {
    ...
    const orbs = useMemo(() => {
        ...
        return [brain, ...appOrbs, ...taskOrbs];
    }, [activeAppCodes, isPro, tasks]);
    ...
    return (
        <div ref={containerRef} className="w-full h-screen relative overflow-hidden bg-white isolate touch-none">
            ...
            {/* Connection Layer */}
            <ConnectionLayer orbIds={orbs.map(o => o.id)} positions={positionsMap} containerRef={containerRef} />
